...
$base_url = "https://taxinformation.cbic.gov.in/api/cbic-notification-msts/fetchNotificationByYearAndCategory";
$category = "Integrated%20Tax"; //category is just hard coded you can change it to get the desired result
for ($year = 2017; $year <= date("Y"); $year++) {
  $curl = curl_init();
  $final_url = $base_url . '?year=' . $year . "&page=0&size=200&taxId=1000001" . '&category=' . $category;
